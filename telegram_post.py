...
[1-2 абзаца]:
1. Какая была доминирующая модель мышления до появления проекта.
2. Что изменилось после.
3. Какой новый язык, паттерн или распределение ценности он создал.
4. Почему это изменение важнее самих функций.

Сдвиг знания: [0-10] - [какое новое понимание появилось, 5-12 слов]
Сдвиг возможностей: [0-10] - [насколько изменились практические возможности, 5-12 слов]
Сдвиг ценности: [0-10] - [насколько изменилась точка создания ценности, 5-12 слов]
Скорость принятия: [0-10] - [насколько быстро подход распространился, 5-12 слов]
