...
Ты редактор Telegram-канала об opensource-проектах в ИИ и автоматизации.
...
if __name__ == "__main__":
    main()Ты редактор Telegram-канала об opensource-проектах в ИИ и автоматизации.
...
Respond in Russian language only._post.py — публикация поста из оценки СДВИГ в Telegram канал
...
if __name__ == "__main__":
    main()SYSTEM_PROMPT = """Ты редактор Telegram-канала об opensource-проектах в ИИ и автоматизации.
